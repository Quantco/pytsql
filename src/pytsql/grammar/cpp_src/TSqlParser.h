...
public:
  ...
  enum {
    ...
    RuleBulk_insert_statement = 247, RuleCreate_database = 248, RuleCreate_index = 249, 
    RuleCreate_index_options = 250, RuleRelational_index_option = 251, RuleAlter_index = 252, 
    RuleResumable_index_options = 253, RuleResumable_index_option = 254, 
    RuleReorganize_partition = 255, RuleReorganize_options = 256, RuleReorganize_option = 257, 
    RuleSet_index_options = 258, RuleSet_index_option = 259, RuleRebuild_partition = 260, 
    RuleRebuild_index_options = 261, RuleRebuild_index_option = 262, RuleSingle_partition_rebuild_index_options = 263, 
    RuleSingle_partition_rebuild_index_option = 264, RuleOn_partitions = 265, 
    RuleCreate_columnstore_index = 266, RuleCreate_columnstore_index_options = 267, 
    RuleColumnstore_index_option = 268, RuleCreate_nonclustered_columnstore_index = 269, 
    RuleCreate_xml_index = 270, RuleXml_index_options = 271, RuleXml_index_option = 272, 
    RuleCreate_or_alter_procedure = 273, RuleAs_external_name = 274, RuleCreate_or_alter_trigger = 275, 
    RuleCreate_or_alter_dml_trigger = 276, RuleDml_trigger_option = 277, 
    RuleDml_trigger_operation = 278, RuleCreate_or_alter_ddl_trigger = 279, 
    RuleDdl_trigger_operation = 280, RuleCreate_or_alter_function = 281, 
    RuleFunc_body_returns_select = 282, RuleFunc_body_returns_table = 283, 
    RuleFunc_body_returns_scalar = 284, RuleProcedure_param_default_value = 285, 
    RuleProcedure_param = 286, RuleProcedure_option = 287, RuleFunction_option = 288, 
    RuleCreate_statistics = 289, RuleUpdate_statistics = 290, RuleUpdate_statistics_options = 291, 
    RuleUpdate_statistics_option = 292, RuleCreate_table = 293, RuleTable_indices = 294, 
    RuleTable_options = 295, RuleTable_option = 296, RuleCreate_table_index_options = 297, 
    RuleCreate_table_index_option = 298, RuleCreate_view = 299, RuleView_attribute = 300, 
    RuleAlter_table = 301, RuleSwitch_partition = 302, RuleLow_priority_lock_wait = 303, 
    RuleAlter_database = 304, RuleAdd_or_modify_files = 305, RuleFilespec = 306, 
    RuleAdd_or_modify_filegroups = 307, RuleFilegroup_updatability_option = 308, 
    RuleDatabase_optionspec = 309, RuleAuto_option = 310, RuleChange_tracking_option = 311, 
    RuleChange_tracking_option_list = 312, RuleContainment_option = 313, 
    RuleCursor_option = 314, RuleAlter_endpoint = 315, RuleDatabase_mirroring_option = 316, 
    RuleMirroring_set_option = 317, RuleMirroring_partner = 318, RuleMirroring_witness = 319, 
    RuleWitness_partner_equal = 320, RulePartner_option = 321, RuleWitness_option = 322, 
    RuleWitness_server = 323, RulePartner_server = 324, RuleMirroring_host_port_seperator = 325, 
    RulePartner_server_tcp_prefix = 326, RulePort_number = 327, RuleHost = 328, 
    RuleDate_correlation_optimization_option = 329, RuleDb_encryption_option = 330, 
    RuleDb_state_option = 331, RuleDb_update_option = 332, RuleDb_user_access_option = 333, 
    RuleDelayed_durability_option = 334, RuleExternal_access_option = 335, 
    RuleHadr_options = 336, RuleMixed_page_allocation_option = 337, RuleParameterization_option = 338, 
    RuleRecovery_option = 339, RuleService_broker_option = 340, RuleSnapshot_option = 341, 
    RuleSql_option = 342, RuleTarget_recovery_time_option = 343, RuleTermination = 344, 
    RuleDrop_index = 345, RuleDrop_relational_or_xml_or_spatial_index = 346, 
    RuleDrop_backward_compatible_index = 347, RuleDrop_procedure = 348, 
    RuleDrop_trigger = 349, RuleDrop_dml_trigger = 350, RuleDrop_ddl_trigger = 351, 
    RuleDrop_function = 352, RuleDrop_statistics = 353, RuleDrop_table = 354, 
    RuleDrop_view = 355, RuleCreate_type = 356, RuleDrop_type = 357, RuleRowset_function_limited = 358, 
    RuleOpenquery = 359, RuleOpendatasource = 360, RuleDeclare_statement = 361, 
    RuleXml_declaration = 362, RuleCursor_statement = 363, RuleBackup_database = 364, 
    RuleBackup_log = 365, RuleBackup_certificate = 366, RuleBackup_master_key = 367, 
    RuleBackup_service_master_key = 368, RuleKill_statement = 369, RuleKill_process = 370, 
    RuleKill_query_notification = 371, RuleKill_stats_job = 372, RuleExecute_statement = 373, 
    RuleExecute_body_batch = 374, RuleExecute_body = 375, RuleExecute_statement_arg = 376, 
    RuleExecute_statement_arg_named = 377, RuleExecute_statement_arg_unnamed = 378, 
    RuleExecute_parameter = 379, RuleExecute_var_string = 380, RuleSecurity_statement = 381, 
    RulePrincipal_id = 382, RuleCreate_certificate = 383, RuleExisting_keys = 384, 
    RulePrivate_key_options = 385, RuleGenerate_new_keys = 386, RuleDate_options = 387, 
    RuleOpen_key = 388, RuleClose_key = 389, RuleCreate_key = 390, RuleKey_options = 391, 
    RuleAlgorithm = 392, RuleEncryption_mechanism = 393, RuleDecryption_mechanism = 394, 
    RuleGrant_permission = 395, RuleSet_statement = 396, RuleTransaction_statement = 397, 
    RuleGo_statement = 398, RuleUse_statement = 399, RuleSetuser_statement = 400, 
    RuleReconfigure_statement = 401, RuleShutdown_statement = 402, RuleCheckpoint_statement = 403, 
    RuleDbcc_checkalloc_option = 404, RuleDbcc_checkalloc = 405, RuleDbcc_checkcatalog = 406, 
    RuleDbcc_checkconstraints_option = 407, RuleDbcc_checkconstraints = 408, 
    RuleDbcc_checkdb_table_option = 409, RuleDbcc_checkdb = 410, RuleDbcc_checkfilegroup_option = 411, 
    RuleDbcc_checkfilegroup = 412, RuleDbcc_checktable = 413, RuleDbcc_cleantable = 414, 
    RuleDbcc_clonedatabase_option = 415, RuleDbcc_clonedatabase = 416, RuleDbcc_pdw_showspaceused = 417, 
    RuleDbcc_proccache = 418, RuleDbcc_showcontig_option = 419, RuleDbcc_showcontig = 420, 
    RuleDbcc_shrinklog = 421, RuleDbcc_dbreindex = 422, RuleDbcc_dll_free = 423, 
    RuleDbcc_dropcleanbuffers = 424, RuleDbcc_clause = 425, RuleExecute_clause = 426, 
    RuleDeclare_local = 427, RuleTable_type_definition = 428, RuleTable_type_indices = 429, 
    RuleXml_type_definition = 430, RuleXml_schema_collection = 431, RuleColumn_def_table_constraints = 432, 
    RuleColumn_def_table_constraint = 433, RuleColumn_definition = 434, 
    RuleColumn_definition_element = 435, RuleColumn_modifier = 436, RuleMaterialized_column_definition = 437, 
    RuleColumn_constraint = 438, RuleColumn_index = 439, RuleOn_partition_or_filegroup = 440, 
    RuleTable_constraint = 441, RuleConnection_node = 442, RulePrimary_key_options = 443, 
    RuleForeign_key_options = 444, RuleCheck_constraint = 445, RuleOn_delete = 446, 
    RuleOn_update = 447, RuleAlter_table_index_options = 448, RuleAlter_table_index_option = 449, 
    RuleDeclare_cursor = 450, RuleDeclare_set_cursor_common = 451, RuleDeclare_set_cursor_common_partial = 452, 
    RuleFetch_cursor = 453, RuleSet_special = 454, RuleSpecial_list = 455, 
    RuleConstant_LOCAL_ID = 456, RuleExpression = 457, RuleParameter = 458, 
    RuleTime_zone = 459, RulePrimitive_expression = 460, RuleCase_expression = 461, 
    RuleUnary_operator_expression = 462, RuleBracket_expression = 463, RuleSubquery = 464, 
    RuleWith_expression = 465, RuleCommon_table_expression = 466, RuleUpdate_elem = 467, 
    RuleUpdate_elem_merge = 468, RuleSearch_condition = 469, RulePredicate = 470, 
    RuleQuery_expression = 471, RuleSql_union = 472, RuleQuery_specification = 473, 
    RuleTop_clause = 474, RuleTop_percent = 475, RuleTop_count = 476, RuleOrder_by_clause = 477, 
    RuleSelect_order_by_clause = 478, RuleFor_clause = 479, RuleXml_common_directives = 480, 
    RuleOrder_by_expression = 481, RuleGrouping_sets_item = 482, RuleGroup_by_item = 483, 
    RuleOption_clause = 484, RuleOption = 485, RuleOptimize_for_arg = 486, 
    RuleSelect_list = 487, RuleUdt_method_arguments = 488, RuleAsterisk = 489, 
    RuleUdt_elem = 490, RuleExpression_elem = 491, RuleSelect_list_elem = 492, 
    RuleTable_sources = 493, RuleNon_ansi_join = 494, RuleTable_source = 495, 
    RuleTable_source_item = 496, RuleOpen_xml = 497, RuleOpen_json = 498, 
    RuleJson_declaration = 499, RuleJson_column_declaration = 500, RuleSchema_declaration = 501, 
    RuleColumn_declaration = 502, RuleChange_table = 503, RuleChange_table_changes = 504, 
    RuleChange_table_version = 505, RuleJoin_part = 506, RuleJoin_on = 507, 
    RuleCross_join = 508, RuleApply_ = 509, RulePivot = 510, RuleUnpivot = 511, 
    RulePivot_clause = 512, RuleUnpivot_clause = 513, RuleFull_column_name_list = 514, 
    RuleRowset_function = 515, RuleBulk_option = 516, RuleDerived_table = 517, 
    RuleFunction_call = 518, RulePartition_function = 519, RuleFreetext_function = 520, 
    RuleFreetext_predicate = 521, RuleJson_key_value = 522, RuleJson_null_clause = 523, 
    RuleBuilt_in_functions = 524, RuleXml_data_type_methods = 525, RuleDateparts_9 = 526, 
    RuleDateparts_12 = 527, RuleDateparts_15 = 528, RuleDateparts_datetrunc = 529, 
    RuleValue_method = 530, RuleValue_call = 531, RuleQuery_method = 532, 
    RuleQuery_call = 533, RuleExist_method = 534, RuleExist_call = 535, 
    RuleModify_method = 536, RuleModify_call = 537, RuleHierarchyid_call = 538, 
    RuleHierarchyid_static_method = 539, RuleNodes_method = 540, RuleSwitch_section = 541, 
    RuleSwitch_search_condition_section = 542, RuleAs_column_alias = 543, 
    RuleAs_table_alias = 544, RuleTable_alias = 545, RuleWith_table_hints = 546, 
    RuleDeprecated_table_hint = 547, RuleSybase_legacy_hints = 548, RuleSybase_legacy_hint = 549, 
    RuleTable_hint = 550, RuleIndex_value = 551, RuleColumn_alias_list = 552, 
    RuleColumn_alias = 553, RuleTable_value_constructor = 554, RuleExpression_list_ = 555, 
    RuleRanking_windowed_function = 556, RuleAggregate_windowed_function = 557, 
    RuleAnalytic_windowed_function = 558, RuleAll_distinct_expression = 559, 
    RuleOver_clause = 560, RuleRow_or_range_clause = 561, RuleWindow_frame_extent = 562, 
    RuleWindow_frame_bound = 563, RuleWindow_frame_preceding = 564, RuleWindow_frame_following = 565, 
    RuleCreate_database_option = 566, RuleDatabase_filestream_option = 567, 
    RuleDatabase_file_spec = 568, RuleFile_group = 569, RuleFile_spec = 570, 
    RuleEntity_name = 571, RuleEntity_name_for_azure_dw = 572, RuleEntity_name_for_parallel_dw = 573, 
    RuleFull_table_name = 574, RuleTable_name = 575, RuleSimple_name = 576, 
    RuleFunc_proc_name_schema = 577, RuleFunc_proc_name_database_schema = 578, 
    RuleFunc_proc_name_server_database_schema = 579, RuleDdl_object = 580, 
    RuleFull_column_name = 581, RuleColumn_name_list_with_order = 582, RuleInsert_column_name_list = 583, 
    RuleInsert_column_id = 584, RuleColumn_name_list = 585, RuleCursor_name = 586, 
    RuleOn_off = 587, RuleClustered = 588, RuleNull_notnull = 589, RuleScalar_function_name = 590, 
    RuleBegin_conversation_timer = 591, RuleBegin_conversation_dialog = 592, 
    RuleContract_name = 593, RuleService_name = 594, RuleEnd_conversation = 595, 
    RuleWaitfor_conversation = 596, RuleGet_conversation = 597, RuleQueue_id = 598, 
    RuleSend_conversation = 599, RuleData_type = 600, RuleConstant = 601, 
    RulePrimitive_constant = 602, RuleKeyword = 603, RuleId_ = 604, RuleSimple_id = 605, 
    RuleId_or_string = 606, RuleComparison_operator = 607, RuleAssignment_operator = 608, 
    RuleFile_size = 609
  };
  ...
  class Bulk_insert_statementContext;
  ...
  public:
    ...
    Bulk_insert_statementContext *bulk_insert_statement();
  ...
  class  Bulk_insert_statementContext : public antlr4::ParserRuleContext {
  public:
    Bulk_insert_statementContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
